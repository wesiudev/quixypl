        ...
        data?.map((talent: any) => (
          ...
          >
            ...
            <div className="px-3 flex flex-col font-coco">
              ...
              <p className="text-white bg-gradient-to-r from-primary to-cta px-2 w-max max-w-full">
                {talent?.city}
              </p>
              <h3 className="text-black">{talent?.title}</h3>
            </div>
          </Link>
        ))
      ) : (
        <div className="flex flex-col w-full items-center justify-center mt-3">
          <div className="w-full flex flex-col items-center justify-center text-center px-4">
            ...
            <p className="max-w-sm text-black p-3">
              Brak firm z branży - skonfiguruj profil i wyświetl się jako
              pierwszy/a{" "}
            </p>
          </div>
          <Link
