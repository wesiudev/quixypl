        ...
        <div>
          ...
          <div className="mt-3">
            ...
            <label htmlFor="uploader3" className="relative group">
              {!formData.logo && !loading ? (
                <div className="cursor-pointer max-w-24 max-h-24 aspect-square  rounded-md border border-primaryHoverStart/30 p-3 flex items-center justify-center">
                  <FaImage />
                </div>
              ) : (
                <div className="relative cursor-pointer max-w-24 max-h-24 aspect-square  rounded-md border border-primaryHoverStart/30 p-3 flex items-center justify-center">
          ...
          <div className="mt-3 flex flex-col rounded-md">
            <div
              className={`${
                light
                  ? "bg-gradient-to-b from-primaryHoverStart/30 to-primaryHoverEnd/30 text-black"
