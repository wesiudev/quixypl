    ...
    <>
      ...
      {slug !== "" && category === "" && (
        <div className="flex flex-col mt-1">
          <div className="mb-1 bg-gradient-to-b from-primaryHoverStart to-primaryHoverEnd rounded-md px-2 py-1 text-white w-max max-w-[100%] h-[32px]">
            {slug}
          </div>
          ...
          <div className="gap-1 flex flex-wrap">
            {jobs.map((item: any, k: any) => (
              <button
                ...
                className="font-light bg-gradient-to-b from-primaryHoverStart to-primaryHoverEnd text-white px-2 py-1 h-[32px] rounded-md hover:from-primaryHoverEnd hover:to-primaryHoverStart duration-200"
                key={uuidv4()}
              >
                {item.title}
              </button>
                              ...
                              <button
                                ...
                                className={`${
                                  ...
                                  job === j.title
                                    ...
                                    : "from-primaryHoverStart to-primaryHoverEnd hover:from-primaryHoverEnd hover:to-primaryHoverStart"
