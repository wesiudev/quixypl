...
export default function JobOfferCard({
  ...
  return (
    ...
    >
      <div className="block p-6 max-w-sm bg-white  border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
