      ...
      >
        <div className="flex w-full justify-between h-full relative">
          ...
          <button
            ...
            className={`text-white font-bold font-coco px-3 py-2 min-h-full max-w-[150px] text-sm sm:text-base rounded-tr-xl bg-gradient-to-r from-primary to-cta items-center text-center`}
          >
            Kontakt
