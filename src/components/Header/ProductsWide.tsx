    ...
    >
      <div className="flex flex-col relative z-[500]">
        <h2 className="text-zinc-800 drop-shadow-xl shadow-black font-bold text-xl xl:text-2xl text-left pt-8">
          Zatrudnij eksperta z Quixy Talent&trade;
        </h2>
          ...
          {jobs.map((job: any, i: any) => (
            <div className="mt-3 ml-3 w-[300px] flex flex-col" key={i}>
              <Link
                ...
                className={`text-lg mt-3 font-bold p-1 px-3 rounded-md text-white bg-orange-500 w-max`}
                key={i}
                ...
                {job.data.map((item: any, i: any) => (
                  <div key={i} className="relative group">
                    <h2
                      ...
                      className="p-0.5 font-light group-hover:text-white group-hover:bg-orange-500 w-max text-gray-800 text-sm"
                    >
                      {item.title}
                    </h2>
                    ...
                    <div className="flex flex-col absolute max-w-[300px] left-0 top-0 group-hover:z-10 z-[-10] opacity-0 group-hover:opacity-100 transition-opacity duration-75">
                      <Link
                        title={`Idź do ${job.title}:${item.title}`}
                        className="p-0.5  group-hover:text-white font-bold group-hover:bg-orange-500 w-max text-gray-800 text-sm"
                      ...
                      {item.data.map((subcategory: any, i: any) => (
                        <Link
                          ...
                          className="max-w-[300px] bg-orange-500 hover:bg-orange-300 duration-75 font-light text-white text-sm p-2"
                          href={`/praca-zdalna/${polishToEnglish(
                            job.title
        ...
        {/* <div className="flex flex-col py-4">
          ...
          <div className="flex items-center flex-wrap -ml-3 mt-3">
            ...
            >
              ...
              <p className="text-xl ml-1 text-zinc-800">TikTok</p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-xl ml-1 text-zinc-800">Facebook</p>
            </Link>
          </div>
        </div> */}
      </div>
