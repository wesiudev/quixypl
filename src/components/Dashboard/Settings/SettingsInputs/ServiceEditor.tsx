          ...
          {project?.tags?.map((item: any, i: any) => (
            ...
            >
              <div
                ...
                } w-max flex items-center justify-center min-h-[40px] sm:min-h-[50px] bg-gradient-to-b from-primaryHoverStart to-primaryHoverEnd hover:from-primaryHoverStart/80 hover:to-primaryHoverEnd/80 rounded-md text-white font-light px-[0.5rem] sm:px-[1rem] text-xs sm:text-sm md:text-base`}
              >
      ...
      <div className="gap-3">
        ...
        {slug?.title !== "" && category?.title === "" && (
          <div className=" flex flex-col">
            <div className="w-max flex items-center justify-center h-[40px] sm:h-[50px] bg-gradient-to-b from-primaryHoverStart to-primaryHoverEnd hover:from-primaryHoverStart/80 hover:to-primaryHoverEnd/80 rounded-md text-white font-light px-[0.5rem] sm:px-[1rem] text-xs sm:text-sm md:text-base">
              {slug.title}
            </div>
            ...
            <div key={i}>
              <div className="relative flex flex-col">
                <Image
                  ...
                  height={1920}
                  alt="image"
                  className=" w-full h-auto border-[2px] border-primaryHoverStart rounded-t-lg"
                />
                {isImageDescriptionOpen === i && (
                  <div>
                    ...
                    <button
                      className="w-full py-2 rounded-b-lg bg-gradient-to-r from-primaryHoverStart to-primaryHoverEnd hover:from-primaryHoverStart/80 hover:to-primaryHoverEnd/80 text-white"
                      onClick={() => {
                ...
                <button
                  className="absolute top-2 right-2 bg-gradient-to-r from-primaryHoverStart to-primaryHoverEnd hover:from-primaryHoverStart/80 hover:to-primaryHoverEnd/80 rounded-full p-2 text-white"
                  onClick={() => {
                    setProject({
                      ...project,
              ...
              {isImageDescriptionOpen !== i && (
                <button
                  ...
                  className="w-full bg-gradient-to-b p-3 rounded-b-md from-primaryHoverStart to-primaryHoverEnd hover:from-primaryHoverStart/80 hover:to-primaryHoverEnd/80 text-white"
                >
                  Opisz obraz
                </button>
              )}
