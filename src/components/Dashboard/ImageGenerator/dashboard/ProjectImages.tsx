                ...
                {project.images.map((image: IProjectImage, i: number) => (
                  ...
                  >
                    <div className="relative">
                      ...
                      <button
                        onClick={() => handlePrev()}
                        className="z-50 opacity-0 sm:opacity-100 bg-gradient-to-r from-primaryHoverStart to-primaryHoverEnd hover:from-primaryHoverStart/80 hover:to-primaryHoverEnd/80 text-white text-lg p-3 absolute left-0 top-1/2 -translate-y-1/2"
                      >
                        <FaChevronLeft />
                      </button>
                      <button
                        onClick={() => handleNext()}
                        className="z-50 opacity-0 sm:opacity-100 bg-gradient-to-r from-primaryHoverStart to-primaryHoverEnd hover:from-primaryHoverStart/80 hover:to-primaryHoverEnd/80 text-white text-lg p-3 absolute right-0 top-1/2 -translate-y-1/2"
                      >
                        <FaChevronRight />
                      </button>
                      {project.images && (
