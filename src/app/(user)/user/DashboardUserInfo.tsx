                  ...
                  >
                    ...
                    <div className="w-full flex flex-wrap items-center gap-2 p-[0.7rem]">
                      {user?.tags?.map((item: any, i: any) => (
                        <div
                          key={i}
                          className="font-sans text-sm lg:text-base bg-gradient-to-b from-primaryHoverStart to-primaryHoverEnd rounded-md text-white duration-100 flex items-center px-[0.5rem] sm:px-[1.5rem] py-[0.5rem]"
                        >
                          {item.title}
                        </div>
                      ))}
