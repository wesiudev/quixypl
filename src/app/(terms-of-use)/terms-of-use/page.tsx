  ...
  return (
    <div className="text-black  prose lg:prose-xl px-12 mx-auto my-48 bg-gray-300 p-12 relative z-[999999999] mb-[100vh]">
      ...
      <div>
        ...
        klientami a &bdquo;talentami&ldquo; specjalizującymi się w pracy IT oraz
        pracy zdalnej.
        <br />
      ...
      <div>
        ...
        <br />
        2.1. Talent &ndash; osoba, która za pomocą platformy Quixy podejmuje
        zlecenia wybrane przez siebie od klientów. Talenty mogą być
        specjalistami z różnych dziedzin IT oraz pracy zdalnej.
        <br />
        2.2. Klient &ndash; osoba lub podmiot, który za pośrednictwem platformy
      ...
      <div>
        ...
        inteligencję.
        <br />
        3.2. Quixy nie pośredniczy w transakcjach finansowych ani nie gwarantuje
        zawarcia umowy o współpracy między klientami a talentami.
      </div>
      <div>
      ...
      <div>
        <div className="text-lg font-bold mt-6">7. Ograniczenia prawne</div>
        <br />
        7.1. Quixy nie gwarantuje, że usługi platformy będą wolne od błędów lub
        dostępne w sposób ciągły.
        <br />
        7.2. Quixy nie ponosi odpowiedzialności za przerwy techniczne, błędy
        systemowe ani inne zakłócenia w działaniu platformy.
      </div>
      <div>
        <div className="text-lg font-bold mt-6">8. Własność intelektualna</div>
        <br />
        8.1. Wszelkie prawa do treści generowanych za pomocą narzędzi Quixy, w
        tym pomysłów stworzonych przez sztuczną inteligencję, przysługują
        użytkownikowi.
        <br />
        8.2. Quixy nie ponosi odpowiedzialności za naruszenie praw autorskich
        wynikające z użytkowania platformy.
      </div>
      <div>
        <div className="text-lg font-bold mt-6">9. Rozstrzyganie sporów</div>
        <br />
        9.1. W przypadku sporu pomiędzy użytkownikiem a Quixy, strony
        zobowiązują się do podjęcia prób polubownego rozwiązania sporu.
        <br />
        9.2. Wszelkie spory będą rozstrzygane przez sąd właściwy dla siedziby
        Quixy.
      </div>
      <div>
        <div className="text-lg font-bold mt-6">10. Zmiany regulaminu</div>
        <br />
        10.1. Quixy zastrzega sobie prawo do zmiany niniejszego regulaminu w
        dowolnym momencie.
        <br />
        10.2. Użytkownik zostanie poinformowany o zmianach regulaminu, a dalsze
        korzystanie z platformy będzie oznaczało akceptację nowych warunków.
      </div>
