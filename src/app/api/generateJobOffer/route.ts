...
export async function POST(req: NextRequest) {
  ...
  try {
    const prompt = `You are generatin an Job Offer, write some skills needed etc... Make sure to return html like in the example responses try to make answer longer. User Input:${position}. Use Polish language return html like in the example responses:{
